...
const Add = ({ token }) => {
  ...
  return (
    <div className="px-4 sm:px-10 py-10 min-h-screen">
      ...
      >
        <div>
          <label className="block mb-2 font-semibold text-gray-800">Product Name</label>
          <input
        ...
        <div>
          <label className="block mb-2 font-semibold text-gray-800">Product Description</label>
          <textarea
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="flex gap-2 pt-2 items-end">
            <label htmlFor="image" className="cursor-pointer transition-all hover:scale-105">
              <img
        ...
        <div>
          <label className="block mb-2 font-semibold text-gray-800">Size and Pricing</label>
          {prices.map((item, index) => (
            <div key={index} className="flex items-center gap-4 mt-2">
              ...
              <input
                ...
                className="px-3 py-2 rounded bg-[#fffdf4] ring-1 ring-slate-200 w-24"
              />
              <button type="button" className="text-red-600 text-xl cursor-pointer">
        ...
        <div className="flex items-center gap-2 mt-4">
          ...
          />
          <label htmlFor="popular" className="text-sm text-gray-700 cursor-pointer">
            Add to popular
          </label>
        </div>
