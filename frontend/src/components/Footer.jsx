...
const Footer = () => {
  return (
   <footer className=" text-neutral-800 px-6 py-12 pb-4">
  ...
  <p className="bg-[#ebf9dc] text-black text-center text-sm  mt-8 flex flex-col sm:flex-row items-center justify-center gap-2">
  <span>&copy; 2025 <strong>FoodLand</strong></span>|<span>All rights reserved.</span>
</p>
